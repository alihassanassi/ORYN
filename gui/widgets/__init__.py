"""
gui/widgets/__init__.py — Custom-drawn PySide6 widgets package.
...
PanelHeader    — Reusable HUD section header with optional action button
VoiceButton    — HUD voice activation button with offline/online/listening states
"""
...
from gui.widgets.panel_header import PanelHeader  # noqa: E402
from gui.widgets.voice_button import VoiceButton  # noqa: E402
